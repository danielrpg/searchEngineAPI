...
//    private EdictDocumentRepository edictDocumentRepository;
    ...
    public void loadAll(){
      ...
      //  userRepository.save(getData());
       ...
       // edictDocumentRepository.save(getAllStartEdicts());
        System.out.println("Loading Completed");
    }

    /**
     * String codeEdict, Date dateEdict, String titleEdict,
     String contextEdict, String typeEdict, Integer numFaceEdict,
     String onservationEdict, String fileEdict, Integer activeEdict
     * @return
     */
//
